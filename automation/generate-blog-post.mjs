  ...
  <div class="wrap">
    <div class="footer-grid">
      ...
      <div class="footer-social">
        ...
        <a href="https://open.spotify.com/artist/1DltOrzqeKYCFvwYXrrSKb" target="_blank" rel="noopener" aria-label="Spotify">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm4.586 14.424a.623.623 0 0 1-.857.207c-2.348-1.435-5.304-1.759-8.785-.964a.623.623 0 1 1-.277-1.215c3.809-.871 7.077-.496 9.712 1.115a.623.623 0 0 1 .207.857zm1.223-2.722a.78.78 0 0 1-1.072.257c-2.687-1.652-6.785-2.14-9.965-1.175a.78.78 0 0 1-.452-1.492c3.632-1.102 8.147-.558 11.234 1.34a.78.78 0 0 1 .255 1.07zm.105-2.835C14.692 8.99 9.375 8.807 6.328 9.732a.935.935 0 1 1-.542-1.79c3.498-1.062 9.372-.857 13.073 1.34a.934.934 0 1 1-.945 1.585z"/></svg>
        </a>
